...
describe CompetitionsController do
  ...
  let(:valid_attributes) { { "year" => "1", "country" => "SPAIN" } }
  ...
  describe "GET index" do
    it "assigns all competitions as @competitions in an ordered hash by country" do
      competition = Competition.create! valid_attributes
      get :index, {}, valid_session
      comp = assigns(:competitions)
      comp["SPAIN"].should eq([competition])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved competition as @competition" do
        ...
        post :create, {:competition => { "year" => "invalid value" }}, valid_session
        assigns(:competition).should be_a_new(Competition)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested competition" do
        ...
        Competition.any_instance.should_receive(:update).with({ "year" => "1" })
        put :update, {:id => competition.to_param, :competition => { "year" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the competition as @competition" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Competition.any_instance.stub(:save).and_return(false)
        put :update, {:id => competition.to_param, :competition => { "year" => "invalid value" }}, valid_session
        assigns(:competition).should eq(competition)
      end
