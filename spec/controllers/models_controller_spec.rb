...
describe ModelsController do
  ...
  let(:valid_attributes) { { "painter_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved model as @model" do
        ...
        post :create, {:model => { "painter_id" => "invalid value" }}, valid_session
        assigns(:model).should be_a_new(Model)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested model" do
        ...
        Model.any_instance.should_receive(:update).with({ "painter_id" => "1" })
        put :update, {:id => model.to_param, :model => { "painter_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the model as @model" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Model.any_instance.stub(:save).and_return(false)
        put :update, {:id => model.to_param, :model => { "painter_id" => "invalid value" }}, valid_session
        assigns(:model).should eq(model)
      end
